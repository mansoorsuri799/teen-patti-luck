...
export const metadata: Metadata = {
  title: "Download Teen Patti Lucky APK Free for Android 2026",
  description:
    "Download Teen Patti Lucky APK (V1.232, 45MB) for Android in Pakistan. Safe install steps, unknown sources fix, and JazzCash-ready setup.",
  alternates: { canonical: `${SITE.origin}${ROUTES.download}` },
  openGraph: {
    title: "Download Teen Patti Lucky APK Free for Android",
    ...
    "@graph": [
      ...
      },
      {
        ...
        step: [
          ...
          { "@type": "HowToStep", name: "Permit install", text: "Allow unknown apps for your browser if Android blocks the file." },
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 md:px-8 py-10">
      ...
      <Breadcrumbs
        items={[
          { name: "Home", href: "/" },
          { name: "Download Teen Patti Lucky" },
        ]}
      />

      <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
        Download Teen Patti Lucky APK for Android
      </h1>
      <p className="text-accent text-lg mb-4">{SITE.version} · {SITE.fileSize} · Free · Pakistan</p>
      <RatingBadge />
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center my-8">
        ...
        <div className="space-y-4 text-center md:text-left">
          <DownloadCTA />
          <p className="text-gray-400 text-sm">Android {SITE.androidMin.replace("Android ", "")} recommended</p>
        </div>
      </div>
      ...
      <section className="mb-10">
        ...
        <ol className="list-decimal list-inside space-y-3 text-gray-300">
          <li>Tap <strong className="text-white">DOWNLOAD NOW</strong> and save the Teen Patti Lucky APK.</li>
      ...
      <section className="mb-10 space-y-3 text-gray-300">
        ...
        <ul className="list-disc list-inside space-y-2">
          <li>Complete OTP signup — see the <Link href={ROUTES.blogLogin} className="text-accent hover:underline">account guide</Link>.</li>
          <li>Claim only bonuses you understand — <Link href={ROUTES.blogBonuses} className="text-accent hover:underline">bonuses overview</Link>.</li>
          <li>Add a small deposit when ready — <Link href={ROUTES.deposit} className="text-accent hover:underline">deposit guide</Link>.</li>
          <li>Read safety notes — <Link href={ROUTES.blogSafety} className="text-accent hover:underline">is Teen Patti Lucky safe?</Link></li>
        </ul>
      </section>

      <section className="mb-10 space-y-3 text-gray-300">
        <h2 className="text-2xl font-bold text-accent">Install problems & fixes</h2>
        <p><strong className="text-white">Parse error:</strong> Re-download; the previous file may be incomplete.</p>
        <p><strong className="text-white">Blocked by Play Protect:</strong> Review details, then install only if you trust this source; disable temporarily if needed and re-enable after.</p>
        <p><strong className="text-white">Not enough storage:</strong> Clear cache or move photos off the phone, then retry Teen Patti Lucky.</p>
      </section>
